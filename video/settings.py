...
SECRET_KEY = '1(hyk=fo*pl48)%1p1+#f15z-&y-)$7$t6m03d!jb57pv-su^$'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'dbfilms'),
    }
}
...
# le serveur d'objets static (doit être externe à l'application en PROD)
